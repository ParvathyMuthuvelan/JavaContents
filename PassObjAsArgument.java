...
public class PassObjAsArgument {
	...
	Test t2=new Test();
	t2.input(3, 4);
	System.out.println("Before calling method a="+t2.a+" b="+t2.b);//3,4
	t2.change(t2.a, t2.b);//8,8
	//t2.modify(t2);//8,8
	System.out.println("After calling method a="+t2.a+" b="+t2.b);//3,4
    t1.input(5,10);
    //r=result
    Test r=t1.update(t1);
    
    System.out.println("After calling update method a="+r.a+" b="+r.b);//6,11
	}
